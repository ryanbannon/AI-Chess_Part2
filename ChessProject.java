...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
  ...
  Boolean agentwins;
  Stack temporary;
	static int chosen; //This will choose whatever agent person wishes to pay -> easy, medium, hard
...
*/
  ...
  System.exit(0);
    ...
    */
	  ...
	  if(chosen==0){ //this is where player chooses the randomMove agent
		   System.out.println("=============================================================");
		   ...
		   if(l instanceof JLabel){
			  ...
			  //If the king is taken, the Ai wins
...
/****Setup the correct movements of the pieces****/
...
//Checking if valid move
    if(!validMove){
      ...
      /*
        Promotion to Queen for white pawn if it reaches the top of blacks side
      */
        if(whiteSuccess){
        ...
        /*
          Promotion to Queen for black pawn if it reaches the top of whites side
        */
...
/****This is the main method that starts the game.****/
        public static void main(String[] args) {
            ...
            Object[] options = {"Random Moves (Easy)","Next Best Move (Medium)","Based on Opponents Moves (Hard)"};
            int n = JOptionPane.showOptionDialog(frame,"Lets play some Chess, please choose your AI opponent","Artificial Intelligence CA Part 2", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,null,options,options[2]);
